...
# --------------------------------------------------------------------------------------------------------------------------
    ...
    def nuevo_cliente(self, mp):
        ...
        #valorescorreo=(self.nombre_paciente.get(),correo,self.descuento.get(),self.condicion_fisica.get())
        ...
        self.lbl_messagess.config(
            text="Registro correcto", fg="green", bg=background)
        self.llenar_tabla_cliente()
        #mails.envia_correoingreso(self,valorescorreo)
        self.limpiar_campos_cliente()
...
#modulo reserva-----------------------------------------------------------------------------------------
    ...
    def generar_reserva(self):
        ...
        q=p.replace(",","")
        r=q.replace("'","")
        valoresr = (int(id_paciente),str(self.timee),estatus)
